...
import DB.DatabaseHandler;
    ...
    public class GetKlippekortByUserID extends AsyncTask<String, Void, String>
    {
        ...
        public GetKlippekortByUserID(String baseUrl, int userID, AsyncResponse delegate, Context context)
        {
        ...
        private String GetKlippekort() throws IOException
        {
            ...
            try
            {
                URL url = new URL(baseUrl + "coffee/mineklippekort/" + userId);
                ...
                Log.d("her er code   ", " code kommer nu:::" + code);
