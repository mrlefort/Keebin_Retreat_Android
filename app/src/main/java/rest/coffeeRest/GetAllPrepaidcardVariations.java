...
public class GetAllPrepaidcardVariations extends AsyncTask<String, Void, String> {

    public AsyncResponse delegate = null;
    private String baseUrl;
    private DatabaseHandler dbh;

    public GetAllPrepaidcardVariations(String baseUrl, AsyncResponse delegate, Context context)
    {
    ...
    private String GetKlippekort() throws IOException
    {
        ...
        try
        {
            URL url = new URL(baseUrl + "coffee/alleklippekortsvariationer/");
